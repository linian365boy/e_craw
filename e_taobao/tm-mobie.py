...
class TM_producs(object):
    ...
    def get_file(self):
        '''创建一个含有标题的表格'''
        title = ['item_id','price','quantity','sold','title','totalSoldQuantity','titleUnderIconList','url','img']
    ...
    def get_products(self,page):
        ...
        title = ['item_id', 'price', 'quantity', 'sold', 'title', 'totalSoldQuantity', 'titleUnderIconList', 'url',
				 'img']
